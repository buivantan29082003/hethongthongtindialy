...
import { Avatar, Breadcrumb, Button, Collapse, Dropdown, InputNumber, Select } from "antd";
...
const PhanCong = () => {
  ...
  const fetching=()=>{
    ...
    apiAdmin.post("order/transfom").then(v=>{
  ...
  const [dataSet, setDataSet] = useState({
    shipper: [
      { id: 1, name: "Nguyễn Văn A", avatar: "https://i.pravatar.cc/40?img=1", selected: false },
      { id: 2, name: "Trần Thị B", avatar: "https://i.pravatar.cc/40?img=2", selected: false },
      { id: 3, name: "Lê Văn C", avatar: "https://i.pravatar.cc/40?img=3", selected: false },
    ],
    maximumOrders: 10,
  });
  ...
  const items = [
    {
      ...
      children: <div>{"Hello cụm 1"}</div>,
      extra: genExtra(),
    },
    {
      key: "2",
      label: "This is panel header 2",
      children: <div>{"Hello cụm 2"}</div>,
      extra: genExtra(),
    },
    {
      key: "3",
      label: "This is panel header 3",
      children: <div>{"Hello cụm 3"}</div>,
      extra: genExtra(),
    },
  ];
  return (
    <>
      <div className="flex items-center gap-4">
        ...
        Fetching<SyncOutlined className="hidden" id="fetching" spin />
        </Button> 
      </div>
    ...
    >
      <button className="p-2 border rounded-md">Chọn shipper</button>
        ...
        <div className="w-2/6">
            <p className="mb-2">Số đơn dự kiến</p>
      ...
      <div className="flex w-full flex-gap gap-2">
        ...
        <div className="w-full lg:w-2/6">
            <p className="font-bold"><InfoCircleOutlined/> About</p>
            <p className="italic mt-3"><GlobalOutlined /> &nbsp; &nbsp;  Huyện Phú Nhuận - Thành Phố Hồ Chí Minh</p>
            <p className="mt-3 font-bold"><UserSwitchOutlined />&nbsp;&nbsp; Nguyễn Thanh Tùng - 0958575757</p>
            <p className="mt-3 font-bold"><LineChartOutlined/>&nbsp;&nbsp;  9 KM</p>
            <p className="mt-3 font-bold"><InboxOutlined/>&nbsp;&nbsp;  2.1 KG</p>
            <p className="mt-3 font-bold"><CustomerServiceOutlined/>&nbsp;&nbsp;  Chuyển phát nhanh</p>
